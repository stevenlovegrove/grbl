...
/* The defaults.h file serves as a central default settings selector for different machine
...
#ifdef DEFAULTS_3040Z_DQ
  // Grbl settings for 3040Z_DQ
  ...
  #define DEFAULT_Z_MAX_RATE 700.0  // mm/min
  ...
  #define DEFAULT_SPINDLE_RPM_MAX 1000.0 // rpm
  #define DEFAULT_SPINDLE_RPM_MIN 0.0 // rpm
  #define DEFAULT_STEP_PULSE_MICROSECONDS 10 // 3040 Instructions say this should be 3, but this is the lowest value that works
  #define DEFAULT_STEPPING_INVERT_MASK 0
  #define DEFAULT_DIRECTION_INVERT_MASK ((1<<Y_AXIS)|(1<<Z_AXIS))
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25 // msec (0-254, 255 keeps steppers enabled)
  #define DEFAULT_STATUS_REPORT_MASK (BITFLAG_RT_STATUS_POSITION_TYPE)
  #define DEFAULT_JUNCTION_DEVIATION 0.02 // mm
  #define DEFAULT_ARC_TOLERANCE 0.002 // mm
  #define DEFAULT_REPORT_INCHES 0 // false
  #define DEFAULT_INVERT_ST_ENABLE 0 // false
